...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "41cebfc1-4e75-48fd-a39c-b79b0e44896c");
      ...
      className="max-w-2xl mx-auto text-gray-600 pt-8">
        <div className="flex flex-wrap ">
          ...
          <div className="w-full md:w-1/2 text-left md:pl-4">
            Your Email
            <input className="w-full border border-gray-300 
            rounded py-3 px-4 mt-2" type="email" name="Email" placeholder="Your Name" required/>
          </div>
        </div>
        ...
        <button className="bg-blue-600 text-white py-2 px-12 mb-10 rounded-md 
